...
function Build-Target {
    ...
    $process = Start-Process -FilePath $cmakeCommand -ArgumentList $cmakeArgs -NoNewWindow -PassThru -RedirectStandardError $outputFile -Wait
    ...
    $process = Start-Process -FilePath $cmakeCommand -ArgumentList $buildArgs -NoNewWindow -PassThru -RedirectStandardError $outputFile -Wait
